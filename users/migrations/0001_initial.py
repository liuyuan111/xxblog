    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('昵称', models.CharField(default='', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send_type', models.CharField(choices=[('register', '注册'), ('forget', '找回密码'), ('update_email', '更改邮箱')], max_length=50, verbose_name='验证码类型')),
