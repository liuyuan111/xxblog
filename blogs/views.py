...
class SearchView(View):
    ...
    def post(self, request):
        ...
        postlist = Post.objects.filter(Q(title__icontains=kw) | Q(content__icontains=kw))
        ...
        for t in tags:
            ...
            tag_messages_list.append(tm)
        try:
            page = request.Get.get('page',1)
        except PageNotAnInteger:
            page = 1

        p = Paginator(postlist, per_page=10,request=request)

        postlist1 = p.page(page)
